        ...
        <div class="dashboard-section p-4"
            ...
            <div class="d-flex justify-content-between align-items-center mb-3">
                ...
                <div>
                    ...
                    <input type="file" id="uploadErrorFile" style="display: none;" accept=".xlsx,.xls" />

                    <button class="btn btn-success" id="uploadErrorFileBtn">
                        <i class="bi bi-upload"></i> Upload Error File
                    </button>

                </div>
            </div>
            <p class="text-muted mb-0">Download the Error File, fill in Correct lead details, and upload it to bulk
                import leads.
            </p>
        </div>
        <!-- Table -->
        ...
        <div class="modal-body">
          <form id="userForm">
            ...
            <div class="row g-3">
              ...
              <div id="addressFields" class="row g-3 d-none">
                ...
                <div class="col-md-6">
                  ...
                  <input type="text" id="userPinCode" placeholder="Enter Pin Code" name="pinCode" class="form-control">
                </div>
              </div>
            ...
            <div class="modal-footer">
              <button type="button" class="btn btn-orange" data-bs-dismiss="modal" style="background-color: orangered;">Cancel</button>
              <button type="submit" id="saveUserBtn" class="btn btn-success" style="background-color: green ;">Save</button>
            ...
            <div class="modal-body">
                <form id="importLeadsForm" enctype="multipart/form-data">
                    <div class="mb-3">
                        ...
                        <input type="file" class="form-control" id="leadFile" name="file" accept=".xlsx,.xls"
                            required />
                    </div>
