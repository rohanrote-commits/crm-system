...
<head>
  ...
  <title>Sign Up | GSTHero Style</title>
...
<body>
  ...
  <header class="top-bar">
    ...
    <div class="contact">
      <a href="mailto:rohan.rote@perennialsys.com">rohan.rote@perennialsys.com</a>
      <span>|</span>
  ...
  <div class="signup-container">
    <div class="signup-box">
      ...
      <form id="signUpForm">
        ...
        <!-- Dependent Fields (Hidden Initially) -->
          ...
          <div class="form-row">
            ...
            <div class="form-group">
              ...
              <select id="state" name="state">
                ...
                <option value="01 Jammu & Kashmir">Jammu & Kashmir</option>
                ...
                <option value="22 Chhattisgarh">Chhattisgarh</option>
                <option value="23 Madhya Pradesh">Madhya Pradesh</option>
                <option value="24 Gujarat">Gujarat</option>
                <option value="26 Dadra &">Dadra & Nagar Haveli & Daman & Diu</option>
        ...
        <div class="form-row">
          <div class="button-row-right" >
            <div class="form-group">
<button type="button" id="cancelBtn" class="btn btn-cancel btn-small" style="width: 100px;">Cancel</button>
              
            </div>
            <div class="form-group">
              <button type="button" id="clearAllBtn" class="btn btn-clear btn-small" style="width: 100px;">Clear All</button>
            </div>
            <div class="form-group">
              <button type="submit" class="btn btn-signup btn-small" style="width: 100px;">Sign Up</button>
