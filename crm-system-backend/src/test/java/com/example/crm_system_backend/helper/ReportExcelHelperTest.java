...
public class ReportExcelHelperTest {
    ...
    void getFilteredDownloadHistory_Success() {
        ...
        User user1 = new User(1010101L, MASTER_ADMIN, 0L);
        User user2 = new User(2020202L, ADMIN, 1010101L);
        User user3 = new User(3030303L, USER, 2020202L);
        User user4 = new User(4040404L, USER, 1010102L);
    ...
    @Test
    void getFilteredDownloadHistory_fail_idMissing() {}

    @Test
    void getFilteredDownloadHistory_fail_roleMissing() {}

    @Test
    void getFilteredDownloadHistory_fail_emailMissing() {}

    @Test
    void getFilteredDownloadHistory_fail_emptyUserList() {}

    @Test
    void getFilteredDownloadHistory_fail_adminIdList() {}

    @Test
    void getFilteredDownloadHistory_fail_emptyEmailList() {}

    @Test
    void getFilteredDownloadHistory_fail_downloadReportList() {}
